...
function visibleElement(clonedNode) {
    return __awaiter(this, void 0, void 0, function () {
        var element;
        return __generator(this, function (_a) {
            element = clonedNode.querySelectorAll('.visible-element');
            if (element) {
...
function embedImages(clonedNode, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(clonedNode instanceof Element)) return [3 /*break*/, 5];
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, visibleElement(clonedNode)];
                case 3:
                    _a.sent();
